...
namespace ЛР__2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Third task
            Console.WriteLine("The amount of information in my full name (Latin): " + (Task.EntropyOfAlphabet(Task.Alphabets.Latin) * "Shkabrov Danila Sergeevich".Length));
            Console.WriteLine("The amount of information in my full name (ASCII): " +
                (Task.EntropyOfAlphabet(Task.Alphabets.Binary) *
                 System.Text.Encoding.Unicode.GetBytes("Shkabrov Danila Sergeevich").Length));
